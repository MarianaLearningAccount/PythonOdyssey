...
# CODUL TĂU VINE MAI JOS:
print(f'Initial value of "age" is: {age}')
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
age = 27
print(f'Updated value of "age" is: {age}')
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
age2 = age
print(f'Initial value of "age2" is: {age2}')
# CODUL TĂU VINE MAI SUS:

# Acum șterge variabila `age` și încearcă să afișezi valoarea variabilei `age` folosind funcția `print`
# CODUL TĂU VINE MAI JOS:
print(f'Value of variable "age2" after deletion of variable "age" is: {age2}') 
# The result was: NameError: name 'age' is not defined
# CODUL TĂU VINE MAI SUS:
