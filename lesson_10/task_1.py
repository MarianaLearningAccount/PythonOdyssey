...
# CODUL TĂU VINE MAI JOS:
def task_2():
    sqaure_numbers_list = [number ** 2 for number in range(1, 11)]
    return sqaure_numbers_list
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
def task_3():
    odd_list = [number for number in range(1, 11) if number % 2 != 0]
    return odd_list
...
# CODUL TĂU VINE MAI JOS:
def task_5(n):
    result = ["par" if number % 2 == 0 else "impar" for number in range(1, n+1)]
    return result
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
def task_6(n):
    result = {number: number ** 3 for number in range(1, n+1)}
    return result
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
def task_7(n):
    result = {x for x in range(1, n+1) if x % 3 == 0}
    return result
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
def task_18(temperatura_celsius):
...
def task_21(numar):
    ...
    suma_puteri_cifre = sum(int(cifra) ** lungime for cifra in numar_str)
    return suma_puteri_cifre == numar
# CODUL TĂU VINE MAI SUS:
