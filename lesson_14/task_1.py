...
class Sistem:
    ...
    def modifica_name_user(self, id_utilizator, nume_nou):
        if id_utilizator in self.__utilizatori:
            ...
            return "Numele utilizatorului a fost modificat cu succes"
        else:
            return "Utilizatorul nu există"
    ...
    def modifica_nivel_acces(self, id_utilizator, nivel_nou):
        if id_utilizator in self.__utilizatori:
            self.__utilizatori[id_utilizator].set_nivel_acces(nivel_nou)
            return "Nivelul de acces al utilizatorului a fost modificat cu succes"
        else:
            return "Utilizatorul nu există"
# CODUL TĂU VINE MAI SUS:
