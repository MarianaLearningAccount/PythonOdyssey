...
# CODUL TĂU VINE MAI JOS:
print(f'Initial type of "age" is: {type(age)}')
# CODUL TĂU VINE MAI SUS:

# Acum asigură-te că variabila `age` este de tipul float.
# CODUL TĂU VINE MAI JOS:
age = float(age)
print(f'Type of "age" after conversion to float is: {type(age)}')
# CODUL TĂU VINE MAI SUS:
...
age2 = float(27)
age3 = float(26)
print(f'Type of "age2" is: {type(age2)}')
print(f'Type of "age3" is: {type(age3)}')
# CODUL TĂU VINE MAI SUS:

# Acum afișează suma vârstelor voastre folosind funcția `print`
# CODUL TĂU VINE MAI JOS:
print(f'age + age2 + age3 = {age + age2 + age3}')
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
print(f'age2 / (age2 ** age3) = {age2 / (age2 ** age3)}')
# CODUL TĂU VINE MAI SUS:
